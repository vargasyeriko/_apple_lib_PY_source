...
def ds_cv():
    ...
    user_decision = input("\n do you want to copy : MATCHED - RESUME - descriptions : - CLIPBOARD ::: <y/E> :::\n").lower()
    if user_decision == 'y':
        ...
        schema = resume(job_desc)  # Call the function and capture its return value
        print(f'{schema}') ######################## match_desc *******************
