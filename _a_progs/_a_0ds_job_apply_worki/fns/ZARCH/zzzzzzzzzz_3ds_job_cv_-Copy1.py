...
def ds_cv():
    ...
    * NEXT STATEMENT ARE MY INSTRUCTIONS FOR YOU :::
    ...
    :::::
    ------- END OF INSTRUCTIONS and now QUICK REMINDER TO YOU :
    
    * NEXT STATEMENT ARE MY EXPERIENCES ::: (ALWAYS MENTION FCA (as is the project I have had with more responsability/sucess))
    THEN FOCUS ON THE NEXT THREE EXPERIENCES and make them very relatable to the job description. make sure you understand 
    that a machine will compare my CV to see if matches the job description, so optimize my CV so it speaks to the job
    with a very professional and confident tone but do not boost or exagerate so much because I am not trying to lie, just maybe
    swicth a couple of words to make my application seem more fitting for the position I am applying to.
    ...
    ************* NEXT STATEMENT is JOB DESCRIPTION I am applying to so read this and please help me out :::
...
# 4 --<<EXPORTS>>
    ...
    input('')
    convert(f"{direc_exp}Yeriko Vargas - Cover Letter.docx",
            f"{direc_arch_cv}applied_{company_name}_{date}_Yeriko Vargas-Cover_Letter - {company_name}_{position}-.pdf" )
    ##############################################################
