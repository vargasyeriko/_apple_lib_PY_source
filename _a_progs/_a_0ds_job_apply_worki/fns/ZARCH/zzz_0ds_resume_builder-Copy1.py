...
def resume(job_desc):
    ...
    subset_df_cai_ford = df_pick_rows[df_pick_rows['CODE'].isin(['General', 'CAI','FORD'])]
    ...
    check_df =df_pick_rows[~df_pick_rows['CODE'].isin([   'General', 'CAI','FORD'])].copy()
    ...
    for code, group in grouped:
        ...
        for index, row in group.iterrows():
           ...
           '''
            ...
            # Print the 'Description', 'rate', and 'score'
