...
# job_desc= '''
# ries AI San Francisco Bay Area Remote
# costumer service
# predictive
# neural
# strategy
...
# Machine Learning
# Save
# Save Lead AI Engineer at Series AI
# Show more options
...
# Yuko Wada 
#  3rd
# Series AI is hiring! Check out open positions at series.ai/careers
# Job poster · LinkedIn member since 2009

# Message
# About the job

# Are you passionate about transforming the landscape of the gaming industry with AI technology? Does the idea of working with generative AI models excite you? If that's the case, we'd love to review your resume!
# We are on the lookout for a competent and seasoned Lead AI Engineer to bolster our expanding team. The perfect candidate should possess a robust background in web development, commendable leadership abilities, and a knack for crafting outstanding software powered by AI technology.

# Responsibilities:
# Lead a remote group of full-stack engineers, imparting mentorship, technical guidance, and feedback to ensure the delivery of top-notch work.
# Coordinate with all stakeholders to carve out ingenious technical strategies, foster mutual understanding among team members, and draft a comprehensive delivery plan.
# Develop top-tier AI-based software products that are user-friendly and high performance.
# Detect technical hindrances and come up with practical, effective solutions.
# Nurture a culture of excellence for the development and maintenance of enduring code.
# Continually redefine what 'state-of-the-art' means in the realm of the games industry, and how this perspective influences day-to-day roles.

# Requirements:
# A proven track record of delivering world-class AI-driven software.
# Strong leadership, communication, and problem-solving abilities.
# Bachelor's degree in Computer Science or an equivalent field or experience.
# 5+ years of experience as a full-stack engineer, with a minimum of 2 years leading a team.
# Expertise in web development technologies like JavaScript, Node.js, React, and SQL databases.
# Experience with cloud platforms like AWS, Azure, or GCP.
# Comprehension of software design patterns and architectural principles.
# Understanding of AI, ML, and specifically Large Language Models (LLMs) and Synthetic Data(SD) generation.
# Acquaintance with agile development methodologies.
# Knowledge of Python is highly desirable.
# Experience with managing remote teams would be beneficial.
